...
parser.add_argument('--input-h', type=int, default=64)
parser.add_argument('--input-w', type=int, default=64)
# Text Encoder
...
# Convolution
parser.add_argument('--cv-filter', type=int, default=64)
...
# f phi
parser.add_argument('--fp-hidden', type=int, default=500)
